...
WildScape Europe Release 1.0 is a client-side React application with deterministic local services and optional public Mapbox configuration. The repository treats security as part of the quality gate rather than a separate afterthought.[1]
...
| User data | Release 1.0 uses deterministic local data and should not persist sensitive personal information. |
