...
<p align="center">
  <img src="docs/assets/wildscape-release-hero.svg" alt="Animated WildScape Europe Release 1.0 hero" width="100%" />
</p>
...
> **Release 1.0 is the stable CloseLight build.** The repository now keeps the product surface rich, the maintenance surface light, and every change close to a repeatable validation gate.

## Release 1.0 note

Release 1.0 turns WildScape Europe into a state-of-the-art product repository rather than a single demo app. The build ships with animated README graphics, SOLID service boundaries, strict domain types, deterministic mock repositories, Vitest coverage across business behavior, zero-warning linting, production deployment guidance, and a focused documentation map.
...
└── README.md                # Release 1.0 overview
```
...
| `npm run docs:check` | Checks authored Markdown for Release 1.0 style requirements, including the no em dash rule. |
...
| Document | Scope |
|---|---|
| [`docs/RELEASE_1_0.md`](docs/RELEASE_1_0.md) | Release 1.0 note, validation evidence, and launch checklist. |
