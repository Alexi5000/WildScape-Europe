...
export const Heading1: React.FC<{ children: React.ReactNode; className?: string }> = ({
  ...
  <h1
    className={`text-5xl md:text-7xl font-serif font-bold text-forest-deep leading-tight mb-6 ${className}`}
  >
    {children}
  </h1>
);
...
export const Heading2: React.FC<{ children: React.ReactNode; className?: string }> = ({
  ...
  <h2
    className={`text-3xl md:text-5xl font-serif font-semibold text-forest-deep leading-tight mb-4 ${className}`}
  >
    {children}
  </h2>
);
...
export const Heading3: React.FC<{ children: React.ReactNode; className?: string }> = ({
  ...
  <h3
    className={`text-2xl md:text-3xl font-serif font-medium text-forest-primary leading-snug mb-3 ${className}`}
  >
    {children}
  </h3>
);
