...
export const WeatherSystem: React.FC<WeatherSystemProps> = ({
  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-10">
      ...
      {currentCondition === "rain" && <div className="absolute inset-0 bg-blue-900/5" />}

      {currentCondition === "snow" && <div className="absolute inset-0 bg-blue-100/10" />}

      {currentCondition === "cloudy" && <div className="absolute inset-0 bg-gray-400/5" />}
    </div>
  );
};
