...
export const InfoSections = () => {
  const sections = [
    ...
    },
    {
      ...
      description: 'The application surfaces real-time style weather conditions, terrain elevation context, seasonal access notes, and aurora-aware Nordic planning cues so travelers can evaluate a site before they commit to a route.',
    ...
    },
    {
      ...
      description: 'Release 1.0 keeps search filters, selected campsites, favorites, booking drafts, dashboard activity, and interface preferences in a deterministic session model designed for reliable local-first use and straightforward backend integration.',
    ...
    },
    {
      ...
      description: 'Travelers can inspect campsite details, review amenities, compare availability, prepare booking details, and track journey activity through a focused dashboard that supports the full planning flow from inspiration to reservation readiness.',
    ...
    },
    {
      ...
      description: 'WildScape Europe promotes low-impact outdoor travel through safety guidance, site context, sustainability messaging, and Leave No Trace planning principles aligned with respectful use of European wilderness areas.',
      image: 'https://images.pexels.com/photos/1001682/pexels-photo-1001682.jpeg?auto=compress&cs=tinysrgb&w=800',
      icon: ShieldCheck,
      accent: '#7A8F5A'
    }
  ...
  return (
    <section id="about" className="py-20 bg-[#F5F2ED]">
      <div className="container mx-auto px-8">
        ...
        >
          <p className="text-sm font-semibold tracking-[0.35em] text-[#C85A54] uppercase mb-4">Release 1.0 Production Build</p>
          <h2 className="text-5xl md:text-6xl font-bold text-[#3E2723] leading-tight font-serif mb-6">About WildScape Europe</h2>
          <p className="text-lg text-[#6B5B47] leading-relaxed">
            A working camping discovery and planning application built in a product lab by a human engineering workflow. Release 1.0 focuses on the complete outdoor planning loop: discover destinations, evaluate conditions, manage session state, prepare bookings, and travel responsibly.
          </p>
        </motion.div>
