...
function App() {
  ...
  const [currentView, setCurrentView] = useState<
    "landing" | "hero" | "explore" | "map" | "dashboard"
  >("landing");
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-forest-mist to-morning-dew flex items-center justify-center">
        ...
        >
          ...
          <p className="text-forest-primary mb-6">{appError || campsitesError}</p>
          <button
      ...
      <div className="min-h-screen bg-gradient-to-br from-morning-dew to-forest-mist flex items-center justify-center relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10" aria-hidden="true">
          <svg viewBox="0 0 1200 800" className="w-full h-full">
            <path
              d="M0,600 Q200,400 400,500 T800,450 Q1000,400 1200,480 L1200,800 L0,800 Z"
              fill="currentColor"
            />
          </svg>
        </div>

        <ForestLoadingSpinner size="lg" message="Preparing your forest sanctuary..." />

        {/* Loading particles */}
        <EnhancedForestParticles density="low" types={["leaf", "dust"]} timeOfDay={timeOfDay} />
      </div>
    );
  }
          ...
          {currentView === "map" && (
            ...
            >
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  <MorphingSearchBar onSearch={handleSearch} onFilterChange={handleFilterChange} />
                </div>
              </motion.div>
